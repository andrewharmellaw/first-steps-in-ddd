...
The First Steps in DDD community is all about learning, discussion,
...
To achieve this goal, all participants
are required to agree with this code of conduct (CoC). Organizers will enforce
this CoC at all times. We expect cooperation from all participants to
help ensure a safe environment for everybody.

This CoC applies for all aspects of this community (not just during
...
these rules after being notified may be sanctioned or expelled at the
discretion of the community organisers.

Points of Contact
-----------------

We recognize that managing harassment is not the job
...
2. Other organizers (if any) will be informed.

3. A discussion will be initiated between the contact person and/or
...
those don't seem to be enough, as we've seen times. There are
